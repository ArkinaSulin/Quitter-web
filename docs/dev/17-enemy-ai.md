...
- **not a hero** and **not the host of an attached hero** — heroes and
  hero-mounted units are played by the players/DM, never by the AI (the
  attached hero token itself is excluded too);
